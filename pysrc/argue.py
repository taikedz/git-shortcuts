...
def parse_args(args=None):
    ...
    graft_p.add_argument("target") # normal rebase target
    ...
    ticket_p.add_argument("--pattern") # if set, is sought and added to message
    ticket_p.add_argument("--off") # remove ticket pat
